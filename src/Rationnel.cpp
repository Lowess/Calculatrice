...
//Realise l'addition d'un Rationnel avec un Constante (Entier, Reel, Rationnel)
LO21::Constante& LO21::Rationnel::addition(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Rationnel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise l'addition Rationnel + Rationnel
        ...
        else{ //Si succes on realise l'addition Rationnel + Reel
            Constante& ref=tmp_re->addition(*this);
            return (ref);
        }
    }
    else{ //Si succes on realise l'addition Rationnel + Entier
        Constante& ref=tmp_en->addition(*this);
        return (ref);
    }
}

//Realise la soustraction d'un Rationnel avec un Constante (Entier, Reel, Rationnel)
LO21::Constante& LO21::Rationnel::soustraction(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Rationnel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la soustraction Rationnel - Rationnel
        ...
        else{ //Si succes on realise la soustraction :Rationnel - Reel
            Constante& ref=tmp_re->soustraction(*this).SIGN(); //Inversion de signe car appel Ã  Reel - Rationnel
            return (ref);
        }
    }
    else{ //Si succes on realise la soustraction Rationnel - Entier
        Constante& ref=tmp_en->soustraction(*this).SIGN(); //Inversion de signe car appel Ã  Entier - Rationnel
        return (ref);
    }
}

//Realise la multiplication d'un Rationnel avec un Constante (Entier, Reel, Rationnel)
LO21::Constante& LO21::Rationnel::multiplication(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Rationnel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la multiplication Rationnel * Rationnel
        ...
        else{ //Si succes on realise la multiplication Rationnel * Reel
            Constante& ref=tmp_re->multiplication(*this);
            return (ref);
        }
    }
    else{ //Si succes on realise la multiplication Rationnel * Entier
        Constante& ref=tmp_en->multiplication(*this);
        return (ref);
    }
}

//Realise la division d'un Rationnel par un Constante (Entier, Reel, Rationnel)
LO21::Constante& LO21::Rationnel::division(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Rationnel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la division Rationnel / Rationnel
        ...
        else{ //Si succes on realise la division Rationnel / Reel
    ...
    else{ //Si succes on realise la division Rationnel / Entier
