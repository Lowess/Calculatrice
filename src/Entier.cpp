...
//Realise l'addition d'un Entier avec un Constante (Entier,Reel,Rationnel)
LO21::Constante& LO21::Entier::addition(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaie en Reel
        ...
        if(tmp_re==0){ //Si echec on essaie en Rationnel
            ...
            else{ //Si succes on realise l'addition Entier + Rationnel
                Entier num=(this->_x * tmp_ra->get_d().get_x() + tmp_ra->get_n().get_x()); //mise au m̻me denominateur et addition des numerateurs
        ...
        else{ //Si succes on realise l'addition Entier + Reel
            Reel* res=new Reel(this->_x + tmp_re->get_x());
            Constante& ref=*res;
            return (ref);
        }
    }
    else{ //Si succes on realise l'addition Entier + Entier
...
//Realise la soustraction d'un Entier avec un Constante (Entier,Reel,Rationnel)
LO21::Constante& LO21::Entier::soustraction(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Reel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la soustraction Entier - Rationnel
                Entier num(this->_x * tmp_ra->get_d().get_x() - tmp_ra->get_n().get_x()); //mise au m̻me denominateur et soustraction des numerateurs
                Entier den(tmp_ra->get_d().get_x());
        ...
        else{ //Si succes on realise la soustraction Entier - Reel
            Reel* res=new Reel(this->_x - tmp_re->get_x());
            Constante& ref=*res;
            return (ref);
        }
    }
    else{ //Si succes on realise la soustraction Entier - Entier
        Entier* res=new Entier(this->_x - tmp_en->_x);
        Constante& ref=*res;
        return (ref);
    }
...
//Realise la multiplication d'un Entier avec un Constante (Entier,Reel,Rationnel)
LO21::Constante& LO21::Entier::multiplication(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Reel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la multiplication Entier * Rationnel
                // x*num/den
        ...
        else{ //Si succes on realise la multiplication Entier * Reel
            Reel* res=new Reel(this->_x * tmp_re->get_x());
            Constante& ref=*res;
            return (ref);
        }
    }
    else{ //Si succes on realise la multiplication Entier * Entier
        Entier* res=new Entier(this->_x * tmp_en->_x);
        Constante& ref=*res;
        return (ref);
    }
...
//Realise la division d'un Entier par un Constante (Entier,Reel,Rationnel)
LO21::Constante& LO21::Entier::division(const Constante& nb) const{
    ...
    if(tmp_en==0){ //Si echec on essaye en Reel
        ...
        if(tmp_re==0){ //Si echec on essaye en Rationnel
            ...
            else{ //Si succes on realise la division Entier / Rationnel
                if(tmp_ra->get_n().get_x()/tmp_ra->get_d().get_x()==0){ //Si division par 0 Exception
                    LogSystem::ecrireLog(LogMessage("Erreur division par zero classe entier ",ERREUR));
        ...
        else{ //Si succes on realise la division Entier / Reel
    ...
    else{ //Si succes on realise la division Entier / Entier
